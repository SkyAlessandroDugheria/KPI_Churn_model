...
SELECT
    ...
    as TTS_OVERNIGHT_linear, 

FROM `skyita-da-datalab-cmo.ds_personal_dataset_cmo_alessandrodugheriastagista.Elementary_DataSet_EXPORT` 
WHERE playback_start2 > date_back and playback_start2 < date_start
AND event_type = "VIEWVOD"
group by sc_sn
